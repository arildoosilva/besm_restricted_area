	...
	?>
		<div id="comment-<?php comment_ID(); ?>" class="comment">
			...
			<div class="comm_content">
				...
				<?php endif; ?>
				<?php edit_comment_link( __( 'Editar', 'metro-creativex' ), '<p class="edit-link">', '</p>' ); ?>
				<div class="reply">
					<?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Responder', 'metro-creativex' ), 'after' => ' <span>&darr;</span>', 'depth' => $depth, 'max_depth' => 20 ) ) ); ?>
				</div><!-- .reply -->
			</div><!--/comm_content-->
...
$fields['logged_in_as'] = '<p class="logged-in-as">' . sprintf( __( 'Logado como <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Sair?</a>' ), admin_url( 'profile.php' ), $user_identity, wp_logout_url( apply_filters( 'the_permalink', get_permalink( ) ) ) ) . '</p>';
$fields['comment_notes_after'] = '';
$fields['label_submit'] = 'Enviar';
return $fields;
}
