...
function generate_setup() 
{
	 ...
	 */
	// add_theme_support( 'post-formats', array( 'aside', 'image', 'video', 'quote', 'link', 'status' ) );  // alterado
 ...
 * Load metaboxes
 */
// require get_template_directory() . '/inc/metaboxes.php';  // alterado
...
function generate_scripts() {
	...
	wp_enqueue_style( 'colorbox', get_template_directory_uri() . '/css/colorbox.css', false, 'all' );
	...
	wp_enqueue_script( 'colorbox', get_template_directory_uri() . '/js/jquery.colorbox-min.js', array('jquery'), true );
...
{
	?>
	<span class="copyright"><?php _e('Copyright','generate');?> &copy; BESM <?php echo date('Y'); ?></span> <?php //do_action('generate_copyright_line');?>
	<?php
}
