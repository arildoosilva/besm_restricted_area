...
function frontier_post_output_msg()
	...
	if ( fp_get_option_bool("fps_show_msg") )
		...
		//echo '<div class="frontier_post_msg">'.$tmp_msg.'</div>';  // alterado
		}
...
function frontier_post_edit_link($fp_post, $fp_show_icons = true, $tmp_plink)
	...
	if (frontier_can_edit($fp_post) == true)
		...
		if ($fp_show_icons)
			...
			{
			$fp_return = '<a class="frontier-post-list-text" id="frontier-post-list-text-edit" href="'.$tmp_plink.$concat.'task=edit&postid='.$fp_post->ID.'">'.__("Editar", "frontier-post").'&nbsp;&nbsp;</a>';
			}
		}
	return $fp_return;
	}
...
function frontier_post_delete_link($fp_post, $fp_show_icons = true, $tmp_plink)
	...
	if (frontier_can_delete($fp_post) == true)
		...
		if ($fp_show_icons)
			...
			{
			$fp_return = '<a class="frontier-post-list-text" id="frontier-post-list-text-delete" href="'.$tmp_plink.$concat.'task=delete&postid='.$fp_post->ID.'">'.__("Deletar", "frontier-post").'&nbsp;&nbsp;</a>';
			}
		}
	return $fp_return;
	}
...
function frontier_post_preview_link($fp_post, $fp_show_icons = true)
	...
	if ($fp_show_icons)
		...
		{
		$fp_return = '<a class="frontier-post-list-text" id="frontier-post-list-text-preview" href="'.site_url().'/?p='.$fp_post->ID.'&preview=true">'.__("Ver", "frontier-post").'&nbsp;&nbsp;</a>';
		}
return $fp_return;
	}
